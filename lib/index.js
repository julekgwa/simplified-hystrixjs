...
function createHystrixCommands(fn, service, circuitBreakerImpl = DEFAULT_CIRCUIT_BREAKER) {
  ...
  if (typeof fn === 'function') {
    hystrixFunctions[fn.name] = createServiceCommand(fn, service, circuitBreakerImpl);
  } else if (Array.isArray(fn)) {
    fn.forEach((func) => {
      hystrixFunctions[func.name] = createServiceCommand(func, service, circuitBreakerImpl);
    });
